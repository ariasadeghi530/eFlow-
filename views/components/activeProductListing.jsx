...
const ActiveProduct = props => {
  if(props.card.isSold){
    return (
      ...
      <div className="uk-card uk-card-default uk-margin-bottom uk-text-muted">
        <div className="uk-card-header">
          ...
          <div className="uk-align-right uk-width-1-2 uk-margin-remove">
            <h3 className="uk-card-title uk-margin-left uk-margin-remove-bottom uk-text-truncate">{'SOLD: ' + props.card.name}</h3>
